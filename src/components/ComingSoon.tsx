...
export default function ComingSoon({
  ...
  return (
    <div className="relative mx-auto flex min-h-[70svh] max-w-3xl flex-col items-center justify-center px-5 py-40 text-center">
      <span className="pointer-events-none absolute top-24 font-display text-[16rem] leading-none text-plum-400/[0.07]">
        𝄞
      </span>
      <p className="relative text-[0.62rem] uppercase tracking-[0.34em] text-plum-400">{t(eyebrow)}</p>
      ...
      <Link
        href="/"
        className="relative mt-8 text-[0.68rem] uppercase tracking-[0.22em] text-plum-300 transition hover:text-plum-600"
      >
