...
export default function ComingSoon({
  ...
  return (
    <div className="relative mx-auto flex min-h-[70svh] max-w-3xl flex-col items-center justify-center px-5 py-40 text-center">
      ...
      <p className="relative text-[0.62rem] uppercase tracking-[0.34em] text-brass-400">{eyebrow}</p>
      <h1 className="relative mt-5 font-display text-5xl text-cream sm:text-6xl">{title}</h1>
      <p className="relative mt-6 max-w-lg text-sm leading-relaxed text-muted">{text}</p>
